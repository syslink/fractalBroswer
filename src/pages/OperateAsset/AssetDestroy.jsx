...
export default class AssetFounderSet extends Component {
  ...
  onSubmit = async (e) => {
    ...
    var amount = new BigNumber(value.amount).shiftedBy(this.state.selectedAsset.decimals);
    var curAmount = new BigNumber(this.state.selectedAsset.amount);
  ...
  onInputPasswordOK = async (e) => {
    ...
    var destroyAmount = new BigNumber(value.amount).shiftedBy(this.state.selectedAsset.decimals).toNumber();
