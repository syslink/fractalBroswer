...
export const REG_PRODUCER = 768;
export const UPDATE_PRODUCER = 769;
export const UNREG_PRODUCER = 770;
export const REMOVE_VOTER = 771;
export const VOTE_PRODUCER = 772;
export const CHANGE_PRODUCER = 773;
export const UNVOTE_PRODUCER = 774;
